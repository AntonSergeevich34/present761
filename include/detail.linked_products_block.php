...
if($arRegion)
{
	...
	if($catalogID = \Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", \Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", '21')))
	{
...
?>
<?
$GLOBALS['arrProductsFilter']['INCLUDE_SUBSECTIONS'] = 'N';
global $USER;
if ($USER->IsAdmin()) {
/* echo '<pre>';
...
$APPLICATION->IncludeComponent(
	...
	"catalog_block_accessories",
	array(
		'COMPATIBLE_MODE'=> 'Y',
		"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
		"IBLOCK_ID" => \Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", '21'),
		...
		"SHOW_BIG_BLOCK" => "N",
		"DISPLAY_TOP_PAGER" => "N",
		"DISPLAY_BOTTOM_PAGER" => "Y"/* ($arParams["DISPLAY_LINKED_PAGER"] ? $arParams["DISPLAY_LINKED_PAGER"] : "N") */,
		...
		"COMPONENT_TEMPLATE" => "catalog_block_accessories",
