...
$APPLICATION->SetPageProperty("title", "Бренды представленные в нашем магазине");
$APPLICATION->SetPageProperty("keywords", "Dr.Koffer, Zippo, Зонты Три Слона");
$APPLICATION->SetPageProperty("description", "Мы являемся официальными партнерами брендов Dr.Koffer, Zippo, Три Слона");
...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PRICE_CODE" => array(
			0 => "с 4.02.2024г для всех маркетплейсов соглашение",
			1 => "юАрхив Инстаграм продажи всеми способами",
			2 => "юИнстаграм продажи всеми способами",
			3 => "OPT",
			4 => "",
		),
		"STORES" => array(
		...
		"SORT_PRICES" => "с 4.02.2024г для всех маркетплейсов соглашение",
		"SORT_REGION_PRICE" => "с 4.02.2024г для всех маркетплейсов соглашение",
		"IBLOCK_CATALOG_TYPE" => "-",
		"SALE_STIKER" => "-",
		"STIKERS_PROP" => "-",
		"OFFER_ADD_PICT_PROP" => "-",
