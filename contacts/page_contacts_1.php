		...
		<div class="item col-md-6 map-full padding0">
			<div class="right_block_store">
				...
				<? if ($arRegion['ID'] == 7048) {
					...
					$APPLICATION->IncludeFile(SITE_DIR."include/contacts-site-map-yandex.php", Array(), Array("MODE" => "html", "TEMPLATE" => "include_area.php", "NAME" => "Карта яндекс"));
				} elseif ($arRegion['ID'] == 6922) {
					$APPLICATION->IncludeFile(SITE_DIR."include/contacts-site-map-yandex-2.php", Array(), Array("MODE" => "html", "TEMPLATE" => "include_area.php", "NAME" => "Карта яндекс"));
				} else {?>
