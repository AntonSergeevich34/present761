...
InitFancyBoxVideo = function () {
  ...
  $(".video_link").fancybox({
    ...
    afterShow: function () {
		// var iframeWin = parent.document.querySelector("[id^='fancybox-frame']");
		// console.log(document.body.scrollHeight);
		// iframeWin.parentNode.style.height = window.screen.height + 'px';
		//console.log(iframeWin);
		//console.log(iframeWin.parentNode);
		//console.log(document.body.scrollHeight);
      if ($(".fancybox-overlay").css("opacity") == 0) {
        setTimeout(function () {
          $(".fancybox-overlay").css("opacity", 1);
