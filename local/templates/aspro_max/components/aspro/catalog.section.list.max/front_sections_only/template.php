												...
												<!-- ============================ NEW CODE ============================= -->
													<?
														$res = \CIBlockElement::GetList(
														    Array(),
														    Array("SECTION_ID" => $arSection["ID"], "INCLUDE_SUBSECTIONS" => "Y",array("LOGIC" => "OR", array("!PREVIEW_PICTURE" => false), array("!DETAIL_PICTURE" => false))),
														    false,
														    false,
														    Array()
														);
														...
														if (!empty($img)) {?>
															<a href="<?=$arSection["SECTION_PAGE_URL"]?>" class="thumb"><img class="lazy img-responsive" data-src="<?=$img["src"]?>" src="<?=\Aspro\Functions\CAsproMax::showBlankImg($img["src"]);?>" alt="<?=($arSection["PICTURE"]["ALT"] ? $arSection["PICTURE"]["ALT"] : $arSection["NAME"])?>" title="<?=($arSection["PICTURE"]["TITLE"] ? $arSection["PICTURE"]["TITLE"] : $arSection["NAME"])?>" /></a>
														<?}else{?>
															<a href="<?=$arSection["SECTION_PAGE_URL"]?>" class="thumb"><img class="lazy img-responsive" data-src="<?=SITE_TEMPLATE_PATH?>/images/svg/noimage_product.svg" src="<?=\Aspro\Functions\CAsproMax::showBlankImg(SITE_TEMPLATE_PATH.'/images/svg/noimage_product.svg');?>" alt="<?=$arSection["NAME"]?>" title="<?=$arSection["NAME"]?>" /></a>
