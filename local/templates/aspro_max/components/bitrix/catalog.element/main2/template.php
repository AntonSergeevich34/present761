		...
		<div class="flexbox flexbox--row">
			...
			<div class="product-chars">
				...
				<?if($arParams['SHOW_GARANTY'] != 'N'):?>
					<div class="info_ext_block">
						<div class="title font_upper_md darken colored_theme_hover_text colored_theme_hover_bg_before"><?=$arParams['TITLE_GARANTY'] ?: 'Условия гарантии';?></div>
						<div class="text text--with-pt font_xs">
							<?$APPLICATION->IncludeFile(SITE_DIR."include/element_detail_garanty.php", Array(), Array("MODE" => "html",  "NAME" => ($arParams['TITLE_GARANTY'] ?: 'Условия гарантии')));?>
						</div>
					</div>
				<?endif;?>
				<?if($arParams['SHOW_BUY_DELIVERY'] != 'N'):?>
					<div class="info_ext_block">
						<div class="title font_upper_md darken colored_theme_hover_text colored_theme_hover_bg_before"><?=$arParams['TITLE_BUY_DELIVERY'] ?: 'Оплата и доставка';?></div>
						<div class="text text--with-pt font_xs">
							<?$APPLICATION->IncludeFile(SITE_DIR."include/element_detail_buy_delivery.php", Array(), Array("MODE" => "html",  "NAME" => ($arParams['TITLE_BUY_DELIVERY'] ?: 'Оплата и доставка')));?>
						</div>
					</div>
				<?endif;?>
			</div>
