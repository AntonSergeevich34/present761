...
if ($arParams['HIDE_UNDER_300'] === 'Y') {
    foreach ($arResult["ITEMS"] as $key => $item) {

        // Получаем цену со скидкой из матрицы
        $discountPrice = $item["PRICE_MATRIX"]["MATRIX"][5]["ZERO-INF"]["DISCOUNT_PRICE"] ?? 0;

        // Если цена меньше 300 — убираем товар из списка
