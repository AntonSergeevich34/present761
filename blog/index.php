...
$APPLICATION->SetPageProperty("title", "Блог магазина Present61 – Идеи для подарков, новости и акции");
$APPLICATION->SetPageProperty("description", "Читайте блог магазина Present61! Здесь вы найдете идеи для подарков, актуальные новости, а также специальные предложения и акции для наших клиентов.");
