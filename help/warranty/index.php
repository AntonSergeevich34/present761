...
$APPLICATION->SetPageProperty("title", "Гарантия на товар");
$APPLICATION->SetPageProperty("keywords", "Гарантия на товар");
$APPLICATION->SetPageProperty("description", "Гарантия на товар");
